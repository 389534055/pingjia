<template>
    <div class='f_manage'>
        ...
        <div>
            <h1>请输入要查询的信息</h1>
            <p>手机号<input type="text"><button><router-link to="/home/valildate">查询</router-link></button></p>
        </div>
        <table>
            <tr>
                <td>租赁方式</td>
  ...
  div{
      ...
      p{
          input{
              ...
              border-radius: 3px;
              outline: none;
              background:url('./../reserve/img/icon.png@2x.png') no-repeat right center;
          }
          button{
              border:none;
              a{
